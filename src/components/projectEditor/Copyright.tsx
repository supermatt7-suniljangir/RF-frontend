        ...
        <div className="w-5/6">
            <div className="mt-4 w-full space-y-6">
                ...
                <div>
                    ...
                    <Select value={license} onValueChange={handleLicenseChange} defaultValue={License.All_Rights_Reserved}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value={License.All_Rights_Reserved}>All Rights Reserved</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
