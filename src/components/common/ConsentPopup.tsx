...
const ConsentPopup = () => {
  ...
  useEffect(() => {
    const hasAcknowledged = localStorage.getItem(
      "radiatorforge-info-acknowledged",
    );
      ...
      <AlertDialogContent className={cn(`!bg-background !text-foreground`)}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className={`text-base font-medium`}>
            ...
            <p className={`mt-4`}>
              This site is not affiliated with or endorsed by Behance. It serves
              solely as a showcase of my development capabilities and is not
