      ...
      <Popover>
        ...
        <PopoverContent className="w-40 p-0">
          <Link href={`/project/editor/${projectId}`}>
            <button className="flex w-full items-center gap-2 px-4 py-2 text-left hover:bg-secondary hover:text-secondary-foreground">
              <Pencil size={12} /> Edit
            </button>
          </Link>
          <button
            onClick={() => setOpenDeleteWindow(true)}
            className="flex w-full items-center gap-2 px-4 py-2 text-left hover:bg-secondary hover:text-secondary-foreground"
          >
